...
function TaskCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
      <Link to="/search" className="bg-gray-900 shadow-lg rounded-2xl p-8 flex flex-col justify-between transform transition duration-300 hover:shadow-sky-500/20 hover:scale-[1.02]">
        <div>
      ...
      <Link to="/classify" className="bg-gray-900 shadow-lg rounded-2xl p-8 flex flex-col justify-between transform transition duration-300 hover:scale-101 hover:shadow-sky-500/20">
        <div>
          ...
          <p className="text-gray-300 mb-4">
            Provide a news excerpt to classify as Business, Health, or Politics, displaying confidence bars based on the first available model.
          </p>
        </div>
        <div className="mt-4 px-4 py-2 border-2 border-sky-500 text-sky-500 hover:bg-sky-500 hover:text-gray-900 font-medium rounded-lg transition text-center">
          Go to Classifier
